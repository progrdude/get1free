...
<div class="bg"
    ...
    <div class="blur h-100">
        <div class="container py-5 h-100">
            <div class="row h-100">
                <div class="col-lg-5 h-100  d-flex align-items-center justify-content-center">
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="card-product">
                            <div class="row h-100">
                                <div class="col-lg-7">
                                    ...
                                    <a href="<?= $site['amazon_url'] ?>" class="btn amz_btn" target="_blank"
                                       style="background: <?= $config_site['color'] ?>">
                            ...
                            switch (star) {
                                ...
                                case '5':
                                    $(".card-body").html(
                                        ...
                                        <a href="https://m.me/105794154969384?ref=w15040896" target="_blank" class="btn mt-5 w-100 btn-warning btn-lg text-uppercase fw-bold leave-button">
