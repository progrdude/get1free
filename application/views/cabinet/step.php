...
<div class="container">
	...
	<div class="row">
        ...
        <?php if($user_order['id'] == '1'){ ?>
                <div class="row mt-5">
                    <div class="col-6"></div>
                    <div class="col-6">
                        <button type="submit" class="btn btn-primary" onclick="updateStep(<?= $user_order['id']?> , 1)">Вперед</button>
                    </div>
...
<?php }elseif($user_order['step'] == 1){ ?>
	<?php if($user_order['happy'] == 1){ ?>
        <div class="row">
            <div style="position: relative" id="progress-bar">
                <div class="step_info d-flex">
        ...
        <?php if($user_order['id'] == '1'){ ?>
            <div class="row mt-5">
                <div class="col-6 d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary " onclick="updateStep(<?= $user_order['id']?> , 0)">Назад</button>

                </div>
                <div class="col-6">
                    <button type="submit" class="btn btn-primary" onclick="updateStep(<?= $user_order['id']?> , 2)">Вперед</button>
                </div>
	...
	<?php if($user_order['happy'] == 0){ ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-lg-8 mx-auto my-5 text-center">
					...
					<img class="irc_mut img-fluid" src="/assets/image/not_smile.png"
						 width="100" height="100">
                    <h2 class="mt-3">We are really sorry to hear you had such a<br>
                        frustrating experience, but we appreciate you<br>
                        bringing this issue to our attention.</h2>
					<h3>We'll contact you in 48 hours to make the full refund</h3>
				</div>
			</div>
		</div>
        <?php if($user_order['id'] == '1'){ ?>
        ...
        <?php } ?>
	<?php }?>
<?php }elseif($user_order['step'] == 2){?>
	<?php if($user_order['star'] == 1){ ?>
    ...
    <?php if($user_order['id'] == '1'){ ?>
        <div class="row mt-5">
            <div class="col-6 d-flex justify-content-end">
                <button type="submit" class="btn btn-primary " onclick="updateStep(<?= $user_order['id']?> , 1)">Назад</button>

            </div>
            <div class="col-6">
                <button type="submit" class="btn btn-primary" onclick="updateStep(<?= $user_order['id']?> , 3)">Вперед</button>
            </div>
...
<?php }elseif ($user_order['step'] == 3){?>
    ...
    <?php if($user_order['id'] == '1'){ ?>
        <div class="row mt-5">
            <div class="col-6 d-flex justify-content-end">
                <button type="submit" class="btn btn-primary " onclick="updateStep(<?= $user_order['id']?> , 2)">Назад</button>
